<template>
  ...
  <div style="height: 680px;"
    class="bg-white w-72 rounded-lg border-lighter border-red-300 border-4 hover:border-red-700 flex-shrink-0 sticky"
  >
    ...
    <div>
      <router-link
        to="/home"
        class="hover:bg-slate-500 hover:text-blue flex items-center py-2 px-4 hover:bg-lightblue rounded-full mr-auto mb-3 }"
      >
    ...
    <button
      ...
      class="text-white mb-6 bg-blue-950 rounded-full font-semibold focus:outline-none w-12 h-12 lg:h-auto lg:w-full p-3 hover:bg-blue-600"
    >
